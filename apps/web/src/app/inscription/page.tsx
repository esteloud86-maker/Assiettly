...
export default function InscriptionPage() {
      ...
      <div className="flex min-h-screen items-center justify-center bg-creme-100 px-4 text-center">
        <div className="max-w-sm space-y-4">
          ...
          <p className="text-charbon-400">
            Un e-mail de confirmation vient de t&rsquo;être envoyé. Confirme ton adresse pour te connecter.
          </p>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-creme-100 px-4">
      <form onSubmit={sInscrire} className="w-full max-w-sm space-y-4">
        <h1 className="mb-6 text-center font-titre text-3xl font-bold text-charbon-800">Créer un compte</h1>
