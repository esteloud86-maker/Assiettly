  ...
  return (
    <section id="tarifs" className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
      ...
      <div className="mt-10 grid gap-5 sm:grid-cols-2">
        <div className="rounded-3xl bg-creme-50 p-6 shadow-sm">
          ...
          <Link
            href="/inscription"
            className="mt-6 block rounded-2xl border border-creme-200 bg-white py-3 text-center font-titre font-semibold text-charbon-800 hover:bg-creme-200"
          >
            Commencer gratuitement
          </Link>
        </div>

        <div className="relative rounded-3xl border-2 border-corail-500 bg-corail-50 p-6 shadow-sm">
